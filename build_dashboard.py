...
async function init(){
  ...
  const _dbgStep=s=>{document.querySelector('#loading p').textContent='Running: '+s;};
  try{_dbgStep('parseLog');allWalks=parseLog(logText);}catch(e){document.querySelector('#loading p').textContent='CRASH in parseLog: '+e.message;document.querySelector('#loading p').style.color='#f85149';return;}
  try{_dbgStep('applyFilters');applyFilters();}catch(e){document.querySelector('#loading p').textContent='CRASH in applyFilters: '+e.message;document.querySelector('#loading p').style.color='#f85149';return;}
  try{_dbgStep('updateStatus');updateStatus(src);}catch(e){document.querySelector('#loading p').textContent='CRASH in updateStatus: '+e.message;document.querySelector('#loading p').style.color='#f85149';return;}
  try{_dbgStep('initMap');initMap();}catch(e){document.querySelector('#loading p').textContent='CRASH in initMap: '+e.message;document.querySelector('#loading p').style.color='#f85149';return;}
  try{_dbgStep('updateMapColors');updateMapColors();}catch(e){document.querySelector('#loading p').textContent='CRASH in updateMapColors: '+e.message;document.querySelector('#loading p').style.color='#f85149';return;}
  try{_dbgStep('updateMapStats');updateMapStats();}catch(e){document.querySelector('#loading p').textContent='CRASH in updateMapStats: '+e.message;document.querySelector('#loading p').style.color='#f85149';return;}
  try{_dbgStep('bindEvents');bindEvents();}catch(e){document.querySelector('#loading p').textContent='CRASH in bindEvents: '+e.message;document.querySelector('#loading p').style.color='#f85149';return;}
  try{
    ...
    document.querySelector('#loading p').textContent='CRASH in toast: '+err.message;
